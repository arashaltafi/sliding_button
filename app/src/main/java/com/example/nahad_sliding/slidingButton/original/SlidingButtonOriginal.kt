package com.example.nahad_sliding.slidingButton.original
...
class SlidingButtonOriginal : FrameLayout {
    ...
    constructor(
        ...
        inflatedView = LayoutInflater.from(context).inflate(R.layout.layout_button_original, this, true)
    }
                ...
                override fun onGlobalLayout() {
                    ...
                    when (trackExtendedTo) {
                        ...
                        TrackExtended.CONTAINER -> {
                            lp.width = 0
                            lp.height = this@SlidingButtonOriginal.measuredHeight
                            lp.marginStart = 0
                            lp.marginEnd = 0
                        }
                    }
    ...
    private fun configureTouch() {
        this.setOnTouchListener { _, event ->
            ...
            Log.e("test123", "\n startTouch original : $startTouch \n " +
                    " maxStartTouch original : $maxStartTouch \n +" +
                    " isStartTouch original : $isStartTouch"
            )
            ...
            Log.e("test123", "\n endTouch original : $endTouch \n " +
                    " maxEndTouch original : $maxEndTouch \n +" +
                    " isEndTouch original : $isEndTouch"
            )
